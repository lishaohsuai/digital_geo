...
void MainViewerWidget::CreateParamWidget(void)
{
	...
	connect(meshparamwidget, SIGNAL(LaplacianProcessSignal()), meshviewerwidget, SLOT(LaplacianProcess()));
}
...
void MainViewerWidget::ShowGAOSI(void) {
	meshviewerwidget->SetDrawMode(InteractiveViewerWidget::GAOSI);
}
